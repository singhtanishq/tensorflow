...
std::vector<Flag> BenchmarkTfLiteModel::GetFlags() {
  ...
  std::vector<Flag> specific_flags = {
      ...
      CreateFlag<bool>(
          "list_signatures", &params_,
          "Lists available signatures in the model and exits. Outputs the "
          "number of signatures followed by the name of each signature, or "
          "'The Model contains 0 signature key(s)' for legacy models.")};
