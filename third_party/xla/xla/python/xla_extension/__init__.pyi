...
class LoadedExecutable:
  ...
  profile_runner: Optional[PGLESessionRunner]
...
def create_profile_runner(retries: int) -> PGLESessionRunner: ...

class PGLESessionRunner:
  def start(self) -> None: ...
  def stop(self) -> None: ...
  def consume_fdo_profile(self) -> Optional[bytes]: ...
  def is_fdo_consumed(self) -> bool: ...
