...
// a proto object or a string representing the JSON encoding of a proto. When
// the wrapper is initialized, only the provided format is stored. If the other
// format is requested from the wrapper later, it is lazily computed and cached
// internally, before it is returned. Subsequent getters will directly return
// the cached value.
//
