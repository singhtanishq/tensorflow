...
void AnnotationMap::AddAnnotation(uint32_t correlation_id,
  ...
  absl::string_view annotation_view = annotation.empty()
                                          ? absl::string_view()
                                          : *strings_.emplace(annotation).first;
  absl::string_view nvtx_range_view = nvtx_range.empty()
                                          ? absl::string_view()
                                          : *strings_.emplace(nvtx_range).first;
