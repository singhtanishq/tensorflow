...
%struct.SE_HOST_KernelCallFrame = type { ptr, ptr, i64, ptr }
%struct.SE_HOST_KernelArg = type { ptr, i64 }

define ptr @LlvmAddI32(ptr noundef %0) {
  %2 = getelementptr inbounds %struct.SE_HOST_KernelCallFrame, ptr %0, i32 0, i32 3
  ...
  %9 = getelementptr inbounds %struct.SE_HOST_KernelCallFrame, ptr %0, i32 0, i32 1
